...
\section{Muhammad Afra Faris 1174041}
	\subsection{Teori}
		\begin{enumerate}
			\item Variable memiliki beberapa jenis:
				\begin{itemize}
					\item Variable yang berisi karakter
					\item Variable yang berisi bilangan bulat
					\item Variable yang berisi desimal
				\end{itemize}
			\item Cara menggunakannya yaitu :
				\begin{itemize}
					\item Untuk karakter, menggunakan tipe data String
					\item untuk bilangan bulat menggunakan tipe data integer
					\item untuk desimal menggunakan tipe data float
					\item untuk true atau false menggunakan tipe data boolean
				\end{itemize}
			\item seperti ini, input (). Lalu dibuatlah x = input () . Kemudian print(x)
			\item Ada +,-,*,/. apabila x = '5' maka string = str(x) sedangkan jika x = 5 maka integer = int(x)
			\item untuk perulangan yang tidak pasti biasanya menggunakan WHILE
				\begin{verbatim}

				i = 0
				while True:
				if i < 8:
				print "Nilai i yaitu : ", i
				i = i + 1
				elif i >= 8:
				break
   
				for : digunakan untuk perulangan yang pasti
				for i in range(0, 8):
				print i
				\end{verbatim}
			\item 
				...
				hasil
				\end{verbatim}
			\item jika type error, ubah string menjadi integer.
			\item Try Except merupakan salah satu penanganan error di Phyton. Caranya letakan try pada sintaks yang ingin di cek lalu enter, 
				kemudian tulis except lalu enter lalu masukan tulisan yang akan di tampilkan.
		\end{enumerate}
	\subsection{Keterampilan Pemrograman}
		\begin{enumerate}
			\item \lstinputlisting{src/chapter2/1174041_1.py}

			\item \lstinputlisting{src/chapter2/1174041_2.py}

			\item \lstinputlisting{src/chapter2/1174041_3.py}
	
			\item \lstinputlisting{src/chapter2/1174041_4.py}

			\item \lstinputlisting{src/chapter2/1174041_5.py}

			\item \lstinputlisting{src/chapter2/1174041_6.py}

			\item \lstinputlisting{src/chapter2/1174041_7.py}

			\item \lstinputlisting{src/chapter2/1174041_8.py}

			\item \lstinputlisting{src/chapter2/1174041_9.py}

			\item \lstinputlisting{src/chapter2/1174041_10.py}
	
			\item \lstinputlisting{src/chapter2/1174041_11.py}
		\end{enumerate}
	\subsection{Keterampilan Penanganan Error}
		\begin{enumerate}
			\item TypeError merupakan sebuah error di dalam tipe data ketika melakukan substring dan ingin memasukkannya ke dalam kondisi for 
				yang hanya menerima tipe int. jadi harus merubah tipe data inputannya yaitu dari string menjadi integer.

			\item \lstinputlisting{src/chapter2/1174041_2err.py}
		\end{enumerate}
...
\section {Kevin Natanael Nainggolan 1174059}
	...
	\begin{enumerate}
		\item Jawaban Soal 1 
			\lstinputlisting{src/chapter2/1174059/117405901.py}
		\item Jawaban Soal 2
			\lstinputlisting{src/chapter2/1174059/117405902.py}
		\item Jawaban Soal 3
			\lstinputlisting{src/chapter2/1174059/117405903.py}
		\item Jawaban Soal 4
			\lstinputlisting{src/chapter2/1174059/117405904.py}
		\item Jawaban Soal 5
			\lstinputlisting{src/chapter2/1174059/117405905.py}
		\item Jawaban Soal 6
			\lstinputlisting{src/chapter2/1174059/117405906.py}
		\item Jawaban Soal 7
			\lstinputlisting{src/chapter2/1174059/117405907.py}
		\item Jawaban Soal 8
			\lstinputlisting{src/chapter2/1174059/117405908.py} 
		\item Jawaban Soal 9
			\lstinputlisting{src/chapter2/1174059/117405909.py}
		\item Jawaban Soal 10 
			\lstinputlisting{src/chapter2/1174059/117405910.py}
		\item Jawaban Soal 11
			\lstinputlisting{src/chapter2/1174059/117405911.py}
\end{enumerate}